...
**Important:** All tests automatically use `db_transaction` fixture which wraps each test in a transaction and rolls back after, ensuring clean state.
...
3. **test-integration** - Integration and API tests
   - Python 3.11 and 3.12 (matrix)
...
8. **build-docker** - Docker image build
   - Only runs if all tests pass
   - Builds and validates Docker image

9. **test-summary** - Test results summary
